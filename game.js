...
// 环保选择题（50道，简化为前5道示例，完整版可直接替换）
const questions = [
    {
        "question": "以下哪种行为最能减少碳排放？",
        "options": [
            "1. 开车上班",
            "2. 步行或骑自行车",
            "3. 使用一次性餐具",
    ...
    {
        "question": "以下哪种能源是可再生的？",
        "options": ["1. 煤炭", "2. 石油", "3. 太阳能", "4. 天然气"],
        "answer": 3,
    },
    {
        "question": "减少塑料污染的最佳方法是什么？",
        "options": [
            "1. 使用一次性塑料袋",
            "2. 回收利用塑料",
            "3. 焚烧塑料",
    ...
    {
        "question": "以下哪种物品可以回收？",
        "options": ["1. 废电池", "2. 玻璃瓶", "3. 食物残渣", "4. 脏纸巾"],
        "answer": 2,
    },
    {
        "question": "温室效应的主要原因是？",
        "options": ["1. 二氧化碳增加", "2. 植树造林", "3. 使用清洁能源", "4. 节约用电"],
        "answer": 1,
    },
    {
        "question": "以下哪种做法有助于保护森林？",
        "options": ["1. 乱砍乱伐", "2. 植树造林", "3. 焚烧树木", "4. 随意丢弃垃圾"],
        "answer": 2,
    },
    {
        "question": "以下哪种动物因环境污染受到威胁？",
        "options": ["1. 家猫", "2. 北极熊", "3. 家鸡", "4. 宠物狗"],
        "answer": 2,
    },
    {
        "question": "以下哪种能源对环境污染最小？",
        "options": ["1. 煤炭", "2. 风能", "3. 石油", "4. 柴油"],
        "answer": 2,
    },
    {
        "question": "减少垃圾的最佳方法是什么？",
        "options": ["1. 垃圾分类", "2. 随意丢弃", "3. 全部焚烧", "4. 埋进土壤"],
        "answer": 1,
    },
    {
        "question": "以下哪种气体是大气污染的主要来源？",
        "options": ["1. 氧气", "2. 二氧化硫", "3. 氮气", "4. 水蒸气"],
        "answer": 2,
    },
    {
        "question": "保护臭氧层的最佳方法是？",
        "options": [
            "1. 使用含氟利昂的制冷剂",
            "2. 减少使用喷雾剂",
            "3. 增加汽车尾气排放",
    ...
    {
        "question": "以下哪种做法有助于减少空气污染？",
        "options": ["1. 多开车", "2. 使用公共交通", "3. 燃放烟花", "4. 露天烧烤"],
        "answer": 2,
    },
    {
        "question": "以下哪种资源是不可再生的？",
        "options": ["1. 风能", "2. 煤炭", "3. 太阳能", "4. 水能"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为可以保护土壤？",
        "options": ["1. 过度使用化肥", "2. 种植绿植", "3. 随意倾倒废液", "4. 焚烧秸秆"],
        "answer": 2,
    },
    {
        "question": "以下哪种海洋生物因塑料污染受害最严重？",
        "options": ["1. 海豚", "2. 海龟", "3. 鲸鱼", "4. 珊瑚"],
        "answer": 2,
    },
    {
        "question": "以下哪种做法能减少能源浪费？",
        "options": [
            "1. 长时间开灯",
            "2. 使用节能灯",
            "3. 不关电器待机",
    ...
    {
        "question": "以下哪种材料最环保？",
        "options": ["1. 塑料", "2. 可降解材料", "3. 泡沫", "4. 一次性木筷"],
        "answer": 2,
    },
    {
        "question": "以下哪种做法能减少噪音污染？",
        "options": [
            "1. 深夜鸣笛",
            "2. 使用隔音设备",
            "3. 高声喧哗",
    ...
    {
        "question": "以下哪种能源是清洁能源？",
        "options": ["1. 煤炭", "2. 核能", "3. 石油", "4. 天然气"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为对保护野生动物有益？",
        "options": [
            "1. 非法狩猎",
            "2. 建立自然保护区",
            "3. 破坏栖息地",
    ...
    {
        "question": "以下哪种做法能减少温室气体？",
        "options": ["1. 砍伐森林", "2. 多植树", "3. 增加工厂排放", "4. 燃烧化石燃料"],
        "answer": 2,
    },
    {
        "question": "以下哪种物品应放入有害垃圾桶？",
        "options": ["1. 纸张", "2. 废电池", "3. 果皮", "4. 玻璃"],
        "answer": 2,
    },
    {
        "question": "以下哪种现象是酸雨的结果？",
        "options": ["1. 土壤肥沃", "2. 建筑物腐蚀", "3. 空气清新", "4. 植物茂盛"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为有助于节约电能？",
        "options": [
            "1. 长时间开电视",
            "2. 关闭不用的电器",
            "3. 使用大功率灯泡",
    ...
    {
        "question": "以下哪种做法能保护海洋生态？",
        "options": ["1. 过度捕捞", "2. 减少海洋垃圾", "3. 倾倒油污", "4. 破坏珊瑚礁"],
        "answer": 2,
    },
    {
        "question": "以下哪种气体导致雾霾？",
        "options": ["1. 氧气", "2. PM2.5", "3. 水蒸气", "4. 氮气"],
        "answer": 2,
    },
    {
        "question": "以下哪种做法有助于节能减排？",
        "options": [
            "1. 长时间开空调",
            "2. 使用太阳能热水器",
            "3. 多开车",
    ...
    {
        "question": "以下哪种动物因气候变化受威胁？",
        "options": ["1. 家狗", "2. 企鹅", "3. 家鸡", "4. 宠物猫"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为能减少白色污染？",
        "options": ["1. 使用塑料袋", "2. 使用布袋", "3. 丢弃塑料瓶", "4. 焚烧塑料"],
        "answer": 2,
    },
    {
        "question": "以下哪种资源需要循环利用？",
        "options": ["1. 水", "2. 阳光", "3. 风力", "4. 空气"],
        "answer": 1,
    },
    {
        "question": "以下哪种做法能减少土地沙漠化？",
        "options": ["1. 过度放牧", "2. 植树造林", "3. 乱砍树木", "4. 开垦荒地"],
        "answer": 2,
    },
    {
        "question": "以下哪种能源利用率最高？",
        "options": ["1. 煤炭", "2. 风能", "3. 石油", "4. 天然气"],
        "answer": 2,
    },
    {
        "question": "以下哪种垃圾属于可回收物？",
        "options": ["1. 废纸", "2. 剩菜", "3. 废电池", "4. 脏塑料"],
        "answer": 1,
    },
    {
        "question": "以下哪种行为对生态系统有害？",
        "options": ["1. 保护湿地", "2. 填湖造田", "3. 植树造林", "4. 垃圾分类"],
        "answer": 2,
    },
    {
        "question": "以下哪种现象与全球变暖有关？",
        "options": ["1. 冰川融化", "2. 空气变冷", "3. 降雨减少", "4. 森林增多"],
        "answer": 1,
    },
    {
        "question": "以下哪种做法能减少光污染？",
        "options": [
            "1. 夜晚开强光灯",
            "2. 使用柔和灯光",
            "3. 增加路灯亮度",
    ...
    {
        "question": "以下哪种行为有助于保护鸟类？",
        "options": ["1. 破坏鸟巢", "2. 设置鸟类喂食点", "3. 使用农药", "4. 砍伐树木"],
        "answer": 2,
    },
    {
        "question": "以下哪种污染与工业排放有关？",
        "options": ["1. 噪音污染", "2. 大气污染", "3. 光污染", "4. 热污染"],
        "answer": 2,
    },
    {
        "question": "以下哪种做法能减少水污染？",
        "options": [
            "1. 乱倒废水",
            "2. 处理污水再排放",
            "3. 过度捕鱼",
    ...
    {
        "question": "以下哪种能源利用不会产生二氧化碳？",
        "options": ["1. 煤炭", "2. 水力发电", "3. 石油", "4. 天然气"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为能保护草原生态？",
        "options": ["1. 过度放牧", "2. 禁止过度开垦", "3. 焚烧草地", "4. 随意丢弃垃圾"],
        "answer": 2,
    },
    {
        "question": "以下哪种现象是大气污染的后果？",
        "options": ["1. 能见度降低", "2. 空气清新", "3. 植物茂盛", "4. 水质变好"],
        "answer": 1,
    },
    {
        "question": "以下哪种做法能减少热岛效应？",
        "options": [
            "1. 增加绿化面积",
            "2. 多建高楼",
            "3. 铺设更多水泥路",
    ...
    {
        "question": "以下哪种物品应放入厨余垃圾桶？",
        "options": ["1. 塑料瓶", "2. 菜叶", "3. 废纸", "4. 电池"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为有助于保护珊瑚礁？",
        "options": ["1. 过度捕捞", "2. 减少海洋污染", "3. 倾倒废物", "4. 破坏海底"],
        "answer": 2,
    },
    {
        "question": "以下哪种做法能减少森林火灾？",
        "options": ["1. 乱丢烟头", "2. 加强防火巡查", "3. 露天焚烧", "4. 随意野炊"],
        "answer": 2,
    },
    {
        "question": "以下哪种能源利用不会破坏生态？",
        "options": ["1. 煤炭开采", "2. 地热能", "3. 石油钻探", "4. 天然气开采"],
        "answer": 2,
    },
    {
        "question": "以下哪种行为能提高空气质量？",
        "options": ["1. 增加汽车使用", "2. 种植树木", "3. 焚烧垃圾", "4. 使用劣质燃料"],
        "answer": 2,
    },
];
...
function startGame() {
    ...
    createTriggers(maze, 28, [playerX, playerY], [endX, endY]); // 触发器总数改为28
    startTime = Date.now();
    gameOver = false;
    gameState = 'playing';
...
function gameLoop() {
    ...
    const remainingTime = 70 - elapsed; // 游戏时间改为70秒
    ...
    if (gameState === 'playing') {
        ...
        // 修复BUG：确保超时和到达终点时结束游戏
        if (playerX === endX && playerY === endY) {
            hintMessage = '恭喜你，你赢了！';
            gameState = 'over'; // 改为明确状态
            gameOver = true;
        ...
        ctx.fillText(hintMessage, screenSize / 2 - 100, screenSize / 2 - 40); // 上移位置
        ctx.fillStyle = COLORS.BLACK;
        ctx.fillText('按Q退出游戏，按R重新开始游戏', screenSize / 2 - 250, screenSize / 2 + 20);
        ctx.fillText('创作者：', screenSize / 2 - 300, screenSize / 2 + 200); // 新增创作者提示
...
document.addEventListener('keydown', (e) => {
    if (gameState === 'playing' && Date.now() - lastMoveTime > moveInterval) {
        ...
        if (e.key.toLowerCase() === 'q') window.close(); // 浏览器限制，可能无效
